...
public class SessionManager {
    ...
    public void setVideoTutorial(int videoTutorial){
        editor.putInt(VideoTutorial, videoTutorial);
        editor.commit();
    }

    public int getVideoTutorial (){
        return pref.getInt(VideoTutorial, 0);
    }

    public void setClickMe(int ClickMe){
        editor.putInt(clickMe, ClickMe);
        editor.commit();
    }

    public int getClickMe (){
        return pref.getInt(clickMe, 0);
    }
